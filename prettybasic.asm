...
;   The following have a leading space if they begin with a letter
        ...
        ;DEFM    "INVERS"
        ;DEFB    'E'+$80
        DEFM    "IN"        ; make it shorter a bit
        DEFB    'V'+$80     ; it's a wasting of the screen space        /egl
        DEFM    "OVE"
        DEFB    'R'+$80
        DEFM    "OU"
        DEFB    'T'+$80
...
// todo apply colors to the BASIC line numbers too.
// i suppose L15EF is in charge /egl
...
L1855:  LD      BC,($5C49)      ; fetch E_PPC the current line which may be
        ...
        LD      D,$3E           ; prepare line cursor '>' in D.
...
L1937:  jp      colStart   ; jump to the new OutChar, now with colors! /egl
        ...
        ; reclaimed space. it's free now! /egl
...
colApplyColor:
                        ...
                        and 00111000b                   ; drop everything except the paper color
                        sra a                           ; shift paper value to the ink part
                        sra a
                        sra a
                        ld c, a                         ;
